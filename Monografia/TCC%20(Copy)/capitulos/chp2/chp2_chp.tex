...
Em que $\xi_k$ é ruído branco, temos um modelo estocástico de nosso sinal, que nos possibilita pensar em soluções mais arrojadas. As equações que caracterizam a solução do modelo AR também são conhecidas como equações de Youle-Walker e têm como solução ótima o chamado algoritmo de Levinson-Durbin [15] o qual não vamos abordar neste trabalho.
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{downsample.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\textwidth]{downsample2.png}
